...
public class Err {
	public static final int OPERATION_NOT_PERMITTED = 1;
	public static final int NO_SUCH_FILE = 2;
	public static final int IO = 5;
	public static final int PERMISSION_DENIED = 13;
	public static final int NOT_DIR = 20;
	public static final int IS_DIR = 21;
	public static final int INVALID_ARG = 22;
	public static final int NO_SPACE = 28;
