...
public class TriggerBoost {

    private static final String THIS_CLASS = TriggerBoost.class.getSimpleName();
...
//        appDBUtils.setAppBoostStatus(testAppPkg, MgmtAppDBUtils.BoostStatus.UNBOOSTED);
...
//        assertTrue(result.isSuccess);
    ...
    @Test
    public void noBoostSetCase() throws Exception {
    ...
    public void unboostedAppCase() throws Exception {
        ...
        //3.Set test app boost status 5(init boost).
        appDBUtils.setAppBoostStatus(testAppPkg, UidInfoAdapter.BoostStatus.INIT_BOOST);
        assertEquals(UidInfoAdapter.BoostStatus.INIT_BOOST, appDBUtils.getAppBoostStatus(testAppPkg));
    ...
    public void boostedAppCase() throws Exception {
        ...
        //4.Set test app boost status 5(init boost).
        appDBUtils.setAppBoostStatus(testAppPkg, UidInfoAdapter.BoostStatus.INIT_BOOST);
        assertEquals(UidInfoAdapter.BoostStatus.INIT_BOOST, appDBUtils.getAppBoostStatus(testAppPkg));
    ...
    private void unboostApp(MgmtAppDBUtils dbUtils, String appPkg) {
        Timestamp beforeTriggerUnboost = new Timestamp(new Date().getTime());
        dbUtils.setAppBoostStatus(appPkg, UidInfoAdapter.BoostStatus.INIT_UNBOOST);
